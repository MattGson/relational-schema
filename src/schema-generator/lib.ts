 ...
 * @param filename
 */
export async function writeJSFile(content: Object, directory: string, filename: string) {
    const fileHeader = `
         /* Auto generated by relational-schema (https://github.com/MattGson/relational-schema) --- DO NOT MODIFY */
 ...
 * @param filename
 */
export async function writeJSONFile(content: Object, directory: string, filename: string) {
